...
class DepthEstimationPipeline(DiffusionPipeline):
    ...
    def __call__(self,
        ...
        # prediction = depth_pred.sigmoid()
        prediction = to_pil(depth_pred.data.squeeze(0).cpu())
        prediction = prediction.resize(input_size, Image.BILINEAR)
    ...
    def single_infer(self,input_rgb:torch.Tensor,
        ...
        # depth_latent = pyramid_noise_like(rgb_latent, discount=0.4)
